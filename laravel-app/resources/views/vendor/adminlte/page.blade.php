...
@if(\Illuminate\Support\Facades\Auth::user()->level == 'admin')
    @php( $dashboard_url = View::getSection('dashboard_url') ?? config('adminlte.dashboard_url', 'user_manager') )
@elseif(\Illuminate\Support\Facades\Auth::user()->level == 'user')
    @php( $dashboard_url = View::getSection('dashboard_url') ?? config('adminlte.dashboard_url1', 'customer_manager') )
@endif
{{--    @else
...
@section('body')
    <div class="wrapper">
        ...
        <nav class="main-header navbar {{config('adminlte.classes_topnav_nav', 'navbar-expand-md')}} {{config('adminlte.topnav_color', 'navbar-white navbar-light')}}">
            <div class="{{config('adminlte.classes_topnav_container', 'container')}}" style="text-align: center">
                    ...
                    @if(session()->get('name'))
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                                    ...
                                    <a href="/view_information" class="dropdown-item" >
                                        <!-- Message Start -->
                                        <div class="media">
                                            <div class="media-body">
